...
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 42.1354079;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 24.74529039999993;
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        var markers = places.map(function (place) {
            var _place$location$coord = _slicedToArray(place.location.coordinates, 2),
                ...
                placeLat = _place$location$coord[1]; // array destructuring
